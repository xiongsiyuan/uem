...
volatile Bytebits _pb_odr @ 0x5005;
#define pb_odr _pb_odr.Byte

#define pb_odr_5 _pb_odr.Bits.bit5

/* Port B input pin value register */
//DEF_8BIT_REG_AT(PB_IDR,0x5006);

volatile Bytebits _pb_idr @ 0x5006;
#define pb_idr _pb_idr.Byte

#define pb_idr_4 _pb_idr.Bits.bit4

/* Port B data direction register */
//DEF_8BIT_REG_AT(PB_DDR,0x5007);

volatile Bytebits _pb_ddr @ 0x5007;
#define pb_ddr _pb_ddr.Byte

#define pb_ddr_4 _pb_ddr.Bits.bit4
#define pb_ddr_5 _pb_ddr.Bits.bit5


/* Port B control register 1 */
//DEF_8BIT_REG_AT(PB_CR1,0x5008);

volatile Bytebits _pb_cr1 @ 0x5008;
#define pb_cr1 _pb_cr1.Byte

#define pb_cr1_4 _pb_cr1.Bits.bit4
#define pb_cr1_5 _pb_cr1.Bits.bit5

/* Port B control register 2 */
//DEF_8BIT_REG_AT(PB_CR2,0x5009);

volatile Bytebits _pb_cr2 @ 0x5009;
...
volatile Bytebits _pc_odr @ 0x500a;
...
#define pc_odr_7 	_pc_odr.Bits.bit7

/* Port C input pin value register */
//DEF_8BIT_REG_AT(PC_IDR,0x500b);
volatile Bytebits _pc_idr @ 0x500b; 
#define pc_idr 		_pc_idr.Byte

#define pc_idr_3 	_pc_idr.Bits.bit3
#define pc_idr_4 	_pc_idr.Bits.bit4
#define pc_idr_5 	_pc_idr.Bits.bit5

/* Port C data direction register */
//DEF_8BIT_REG_AT(PC_DDR,0x500c);
volatile Bytebits _pc_ddr @ 0x500c;
#define pc_ddr 		_pc_ddr.Byte

#define pc_ddr_3 	_pc_ddr.Bits.bit3

/* Port C control register 1 */
//DEF_8BIT_REG_AT(PC_CR1,0x500d);
volatile Bytebits _pc_cr1 @ 0x500d;
#define pc_cr1 		_pc_cr1.Byte

#define pc_cr1_3 	_pc_cr1.Bits.bit3

/* Port C control register 2 */
//DEF_8BIT_REG_AT(PC_CR2,0x500e);
volatile Bytebits _pc_cr2 @ 0x500e;
...
volatile Bytebits 	_i2c_sr1 @ 0x5217;
...
volatile Bytebits _tim4_cr1 @ 0x5340;
#define tim4_cr1 _tim4_cr1.Byte

#define tim4_cen _tim4_cr1.Bits.bit0//counter enable=1
